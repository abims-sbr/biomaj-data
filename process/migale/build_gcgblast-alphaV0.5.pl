...
B<build_gcgblast.pl> - GCG BLAST indexation with formatdb+ in BioMaJ workflow or in standalone mode.
...
=head2 GCGBLAST indexation for Genbank
...
=item - Use formatdb+ indexation program
