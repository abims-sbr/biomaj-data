...
B<build_gcg.pl> - GCG indexation with dataset+ and prositetogcg program in BioMaJ workflow or in standalone mode.
...
=head2 GCG indexation for Genbank
...
=item - Use and support all dataset+ options

=item - Support PROSITE bank indexation
